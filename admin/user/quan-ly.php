...
$total_records_sql = "SELECT COUNT(*) AS total_records FROM users";
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <table class="table card-table table-vcenter text-nowrap datatable">
                                ...
                                <tbody>
                                <?php foreach ($result as $userItem) {?>
                                    <tr>
                                        <td><input class="form-check-input m-0 align-middle" type="checkbox" aria-label="Select invoice"></td>
                                        <td><span class="text-secondary"><?= $userItem['id'] ?></span></td>
                                        <td><span class="text-secondary"><?= $userItem['role_id'] ?></span></td>
                                        <td><a href="#" class="text-reset" tabindex="-1"><?= $userItem['username'] ?></a></td>
                                        <td>
                                            <p><?= $userItem['email'] ?></p>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-center">
                                            <div class="table-actions">
                                                <a href="?controller=user&action=edit&user_id=<?= $userItem['id'] ?>" class="btn btn-green w-100 btn-icon">
                                                ...
                                                <button class="btn btn-red w-100 btn-icon btn-delete-user" data-bs-toggle="modal" data-bs-target="#modal-danger" data-item-id="<?= $userItem['id']?>">
                            ...
                            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body text-center py-4">
                                        ...
                                        <h3>Xoá tài khoản?</h3>
                                        <div class="text-secondary">Bạn có chắc muốn xoá tài khoản này. Những gì bạn đã làm không thể hoàn tác được.</div>
                                    </div>
                        ...
                        <div class="card-footer d-flex align-items-center">
                            ...
                            // In ra liên kết "Last" nếu không phải ở trang cuối cùng
                            if ($has_next_page) {
