<?php
$base_url = "/admin/index.php?controller=category";

$sql = "SELECT * FROM product_categories";

$result = mysqli_query($conn, $sql);
while ($categoryItem = mysqli_fetch_assoc($result)) {
    $categories[] = $categoryItem;
}

$records_per_page = 2;

$total_records_sql = "SELECT COUNT(*) AS total_records FROM product_categories";
...
$sql = "SELECT * FROM product_categories LIMIT $records_per_page OFFSET $offset";
                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <table class="table card-table table-vcenter text-nowrap datatable">
                                ...
                                <tbody>
                                <?php foreach ($result as $categoryItem) { ?>
                                    <tr>
                                        <td><input class="form-check-input m-0 align-middle" type="checkbox" aria-label="Select invoice"></td>
                                        <td><span class="text-secondary"><?= $categoryItem['id'] ?></span></td>
                                        <td><a href="#" class="text-reset" tabindex="-1"><?= $categoryItem['category_name'] ?></a></td>
                                        <td>
                                        ...
                                        <td class="text-end">
                                            <div class="row g-2 align-items-center">
                                                ...
                                                <div class="col-6 col-sm-4 col-md-2 col-xl-auto py-3">
                                                    <a href="?controller=category&action=edit&cate_id=<?= $categoryItem['id'] ?>" class="btn btn-green w-100 btn-icon">
                                                ...
                                                <div class="col-6 col-sm-4 col-md-2 col-xl-auto py-3">
                                                    <button class="btn btn-red w-100 btn-icon btn-delete-category" data-bs-toggle="modal" data-bs-target="#modal-danger" data-item-id="<?= $categoryItem['id']?>">
                            ...
                            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body text-center py-4">
                                        ...
                                        <h3>Xoá danh mục?</h3>
                                        <div class="text-secondary">Bạn có chắc muốn xoá danh mục này. Những gì bạn đã làm không thể hoàn tác được.</div>
                                    </div>
